...
pascal ComponentResult getPerianCodecInfo(ComponentInstance self, OSType componentType, void *info)
{
    ...
    else 
    {
		...
		case 'xtor':
			...
			err = GetComponentResource((Component)self, codecInfoResourceType, kDxtoryCodecInfoResID, (Handle *)&tempCodecInfo);
			break;
