...
#define LIBAV_CONFIGURATION "--extra-ldflags='-isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6 -Dattribute_deprecated= -fvisibility=hidden -w -arch i386' --cpu=core2 --extra-cflags='-arch i386 -isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.6 -Dattribute_deprecated= -fvisibility=hidden -w -fstrict-aliasing -mdynamic-no-pic ' --cc=/Developer/usr/bin/gcc-4.2 --disable-amd3dnow --disable-doc --disable-encoders --disable-avprobe --disable-avserver --disable-muxers --disable-network --disable-avfilter --disable-ffmpeg --disable-avconv --target-os=darwin"
